...
export function SettingsPage() {
  ...
  async function handleCreate(name: string, documents: Document[], _initialDocuments: Document[], onClose: () => void) {
    try {
  ...
  async function handleUpdate(ownerId: number, name: string, documents: Document[], initialDocuments: Document[], onClose: () => void) {
    try {
      ...
      for (const doc of documents) {
        ...
        if (doc.isDeleted && isExisting) {
          await deleteOwnerDocument(ownerId, doc.id as number);
  ...
  async function handleDelete(ownerId: number) {
    try {
